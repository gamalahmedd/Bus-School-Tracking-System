...
void DIO_ConfigPort(DIO_PortTypes PortID, u_int8 PortValue)
{
	switch(PortID)
	{
		case DIO_PortA:
			DDRA_Register = PortValue;
			break;
		case DIO_PortB:
			DDRB_Register = PortValue;
			break;
		case DIO_PortC:
			DDRC_Register = PortValue;
			break;
		case DIO_PortD:
			DDRD_Register = PortValue;
			break;
		case DIO_PortE:
			DDRE_Register = PortValue;
			break;
		case DIO_PortF:
			DDRF_Register = PortValue;
			break;
		case DIO_PortG:
			DDRG_Register = PortValue;
			break;
	}
}
